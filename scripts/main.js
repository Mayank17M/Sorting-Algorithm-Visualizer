...
var inp_new=document.getElementById("new_arr");
...
inp_new.addEventListener("click",generate_array);
...
function generate_array()
{
    ...
    {
        div_sizes[i]=Math.floor(Math.random() * 0.5*(inp_size.max - inp_size.min) ) + 10;
